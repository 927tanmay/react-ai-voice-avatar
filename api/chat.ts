...
const SYSTEM_PROMPT = [
  ...
  '- You can be interrupted. If the visitor talks over you, you stop mid-sentence and',
  '  listen; it is on by default and is the feature worth trying. Never say you have to',
  '  finish first.',
