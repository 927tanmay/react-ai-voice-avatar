 ...
 */
const GREETING =
  "Hi! Everything you're hearing and seeing is running in your browser. " +
...
const SYSTEM_PROMPT =
  ...
  'such as OpenAI or Claude through an onSubmit prop; it is MIT licensed and installs from npm. ' +
 ...
 * Whisper base 278 MB, Qwen2.5-0.5B at q4 750 MB, Kokoro at fp32 310 MB. This
 * page used to say 0.6 GB, which was less than half of it.
 */
const DOWNLOAD_SIZE = '~1.3 GB';
        ...
        {!engaged && (
          <>
            ...
            <p style={noteStyle}>
              ...
              {hasWebGpu && isMobile && (
                <span style={{ display: 'block', marginTop: '8px', color: '#F59E0B' }}>
                  That's a large download for a phone. It works best on a desktop.
                </span>
              )}
            </p>
          </>
...
/** The models this demo loads, named for a visitor rather than an engineer. */
